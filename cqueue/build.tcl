...
proc _doc {{dst {../embedded}}} {
    ...
    file delete -force $dst/man/files/cqueue
    file delete -force $dst/www/doc/files/cqueue

    file mkdir $dst/man/files/cqueue
    file mkdir $dst/www/doc/files/cqueue

    puts "Generating man pages..."
    exec 2>@ stderr >@ stdout dtplite -ext n -o $dst/man nroff cqueue
    puts "Generating 1st html..."
    exec 2>@ stderr >@ stdout dtplite -merge -o $dst/www html cqueue
