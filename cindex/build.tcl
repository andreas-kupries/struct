...
proc _doc {{dst {../embedded}}} {
    ...
    file delete -force $dst/man/files/cindex
    file delete -force $dst/www/doc/files/cindex

    file mkdir $dst/man/files/cindex
    file mkdir $dst/www/doc/files/cindex

    puts "Generating man pages..."
    exec 2>@ stderr >@ stdout dtplite -ext n -o $dst/man nroff cindex
    puts "Generating 1st html..."
    exec 2>@ stderr >@ stdout dtplite -merge -o $dst/www html cindex
