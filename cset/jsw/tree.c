...
static jsw_anode_t *new_node ( jsw_tree_t *tree, void *data )
{
...
{
  jsw_tree_t *rt = (jsw_tree_t *)malloc ( sizeof *rt );
...
{
  return malloc ( sizeof ( jsw_trav_t ) );
}
...
/*
  ...
  handles min and max
*/
static void *start ( jsw_trav_t *trav,
  jsw_tree_t *tree, int dir )
{
  trav->tree = tree;
  trav->it = tree->root;
  trav->top = 0;
...
*/
static void *move ( jsw_trav_t *trav, int dir )
{
