...
proc _doc {{dst {../embedded}}} {
    ...
    file delete -force $dst/man/files/cstack
    file delete -force $dst/www/doc/files/cstack

    file mkdir $dst/man/files/cstack
    file mkdir $dst/www/doc/files/cstack

    puts "Generating man pages..."
    exec 2>@ stderr >@ stdout dtplite -ext n -o $dst/man nroff cstack
    puts "Generating 1st html..."
    exec 2>@ stderr >@ stdout dtplite -merge -o $dst/www html cstack
